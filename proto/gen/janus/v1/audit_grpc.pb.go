...
const (
	AuditService_ListEvents_FullMethodName     = "/janus.v1.AuditService/ListEvents"
	AuditService_GetTrace_FullMethodName       = "/janus.v1.AuditService/GetTrace"
	AuditService_ListTaskEvents_FullMethodName = "/janus.v1.AuditService/ListTaskEvents"
)
...
func (c *auditServiceClient) ListTaskEvents(ctx context.Context, in *ListTaskEventsRequest, opts ...grpc.CallOption) (*ListTaskEventsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListTaskEventsResponse)
	err := c.cc.Invoke(ctx, AuditService_ListTaskEvents_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuditServiceServer) ListTaskEvents(context.Context, *ListTaskEventsRequest) (*ListTaskEventsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListTaskEvents not implemented")
}
...
func _AuditService_ListTaskEvents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListTaskEventsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuditServiceServer).ListTaskEvents(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuditService_ListTaskEvents_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuditServiceServer).ListTaskEvents(ctx, req.(*ListTaskEventsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuditService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "janus.v1.AuditService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuditService_ListTaskEvents_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "janus/v1/audit.proto",
}
